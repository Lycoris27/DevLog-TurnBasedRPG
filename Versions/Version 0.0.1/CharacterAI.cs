...
public class CharacterAI : MonoBehaviour
{
    ...
    {
        return eMovement.GetIfMove();
    }
    public void ToggleCharacterMove()
    {
        eMovement.ToggleMove();
    }
    ...
    public void SetPosition(Vector2Int pos) // used to move character without autopathing
    {
        eMovement.SetPosition(pos);
    }
    public Vector2Int ReturnPosition()
    {
        return eMovement.ReturnPosition();
    }
